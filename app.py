...
if uploaded_zip_file and st.session_state.df is None:
    ...
    if load_result["status"] == "success":
        ...
        st.write("Dados carregados com sucesso! Aqui está uma pré-visualização:")
            ...
            if isinstance(response_content, dict) and "status" in response_content:
                if response_content["status"] == "success":
                    ...
                    if "data" in response_content:
                        st_callback.dataframe(pd.read_markdown(response_content["data"]))
                        st.session_state.messages.append({"role": "assistant", "content": pd.read_markdown(response_content["data"])})
